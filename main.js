    ...
    productos.forEach((producto, indice) => {
      ...
      card.innerHTML = ` <div class="card" >
          ...
          <div class="card-body">
            ...
            <a  class="btn btn-primary" id="boton" onClick="agregarNotificar(${indice})">Agregar al Carrito</a>
          </div>
          </div>`;
...
const agregarAlCarrito = (indice) => {
  ...
  if (indiceEncontradoCarrito === -1) {
    // si el producto no lo encontro pq no lo agregue antes, que lo agregue al carrito
...
const eliminarProducto = (indice) => {
  ...
  // Luego de modificar el carrito, guardo en localStorage
  guardarCarritoEnLocalStorage();
};
...
const finalizarCompra = () => {
  ...
  // Luego de finalizar la compra, guardo en localStorage
  guardarCarritoEnLocalStorage();
...
const validarForm = () => {
  ...
  if (
    !nombre.value &&
    !expRegNombre.exec(nombre.value) &&
    !correo.value &&
    !expRegCorreo.exec(correo.value) &&
    !telefono.value &&
    !expRegTelefono.exec(telefono.value) &&
    !domicilio.value &&
    !expRegDomicilio.exec(domicilio.value)
  ) {
    Swal.fire({
      icon: "error",
      title: "Oops...",
